...
> Μπορείς εύκολα να φτιάξεις ένα σύστημα μόνος σου. Διάλεξε ένα διάνυσμα λύσης *x*, πολλαπλασίασε το με τον επιθυμητό πίνακα *A* και υπολόγισε ποιο είναι το *b*.
