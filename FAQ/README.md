...
> Προφανώς και όχι. Η εξέταση δεν έχει σκοπό να διερευνήσει αν μπορείτε να βρείτε από κάπου γραμμές κώδικα που να είναι σχετικές με την ερώτηση που έχει το διαγώνισμα. 
**Μην αντιγράφετε πράγματα που δε καταλαβαίνετε στις απαντήσεις σας στο διαγώνισμα**, διότι αυτό είναι έκδηλο και δεν βοηθά. 
